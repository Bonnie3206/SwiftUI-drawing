...
//  iOS_1101_Hw1
//
//  Created by CK on 2021/10/13.
//
//窗戶色.fill(Color(red: 0.79, green: 0.65, blue: 0.65))
//阿比皮膚色.fill(Color(red: 0.55, green: 0.55, blue: 0.01))
//阿比輪子.fill(Color(red: 0.1, green: 0.55, blue: 0.01))
//阿比身體.fill(Color(red: 1, green: 0.92, blue: 0.8))
//巧克力身體.fill(Color(red: 139/255, green: 69/255, blue: 19/255))
//巧克力窗戶.fill(Color(red: 204/255, green: 85/255, blue: 0/255))
//巧克力輪子.fill(Color(red: 1, green: 0.38, blue: 0.27))
